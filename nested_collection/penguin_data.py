...
# How many penguins are recorded in each region

# Which region has the highest number of penguins

# What is the minimum and maximum body mass in the dataset

# What is the average flipper length overall

# Which penguin has the longest bill length

# Which region has the longest average flipper length

# Which region shows the widest variation in body mass

# How many penguins weigh more than 5000 g

# Which penguins have flipper length above 220 mm

# List penguins with bill length greater than 50 mm.

# Which region contains the most heavy penguins (>4500 g)

# How many penguins have both long flippers (>210) and long bills (>50)
